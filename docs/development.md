...
This document covers RedfireForge's internal architecture, UI configuration, feature reference, branching strategy, and data persistence model — everything beyond the Quick Start in the main [README](../README.md).
